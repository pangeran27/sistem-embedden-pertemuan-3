"""
Percobaan 1 — Full Duplex STM32 ↔ ESP32 ↔ Python GUI
=====================================================
User Interface (Tkinter) untuk:
  • Mengontrol 4 LED di STM32   (toggle ON/OFF)
  • Menampilkan status 2 Push Button di STM32  (real-time)
...
class FullDuplexGUI:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("Percobaan 1 — Full Duplex Control Panel")
    ...
    def _build_ui(self):
        ...
        self.txt_log = tk.Text(frm_log, height=8, state="disabled", font=("Consolas", 9))
